...
import com.example.lenovo.admintabungan.network.ApiServices;
import com.example.lenovo.admintabungan.network.InitLibrary;
import com.example.lenovo.admintabungan.response.Distance;
import com.example.lenovo.admintabungan.response.Duration;
import com.example.lenovo.admintabungan.response.LegsItem;
...
public class DirectionActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private String API_KEY = "AIzaSyBPG0aw83iY549saMNYr7MnxAoHJYRfIAM";

    private LatLng pickUpLatLng = new LatLng(-7.6453, 112.9075); // Pasuruan
    private LatLng locationLatLng = new LatLng(-7.9797,112.6304); // Malang
